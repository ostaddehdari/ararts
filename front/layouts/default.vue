  ...
  <v-app>
    ...
    >
      ...
      <div class="d-flex align-center">
        <!-- افزودن آلبوم (دسکتاپ: آیکون+متن، موبایل: فقط آیکون) -->
        <v-btn
          color="primary"
          class="mx-2 d-none d-md-flex add-album-btn"
          variant="outlined"
          @click="addAlbum"
        >
        ...
        <v-btn
          color="primary"
          class="mx-2 d-flex d-md-none add-album-btn"
          icon
          variant="outlined"
          @click="addAlbum"
        >
    ...
    <!-- محتوا -->
    <v-main>
      <v-container :class="{ 'content-with-sidebar': drawer }">
        <slot />
      </v-container>
    </v-main>
